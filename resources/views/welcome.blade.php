            ...
            <div  style="position: relative;">
                <div class="row m-5" >
                    <div class="col-md-12 col-12 col-xl-6" id="text">
                       ...
                       @guest
                        <a href="{{ route('register') }}"><button class="btn btn-outline-light sign mt-3" >Commencer Maintenant!</button></a>
                      @else
                       <a href="/p/create"><button class="btn btn-outline-light sign mt-3" >Soumettre un événement</button></a>
                      @endguest
                    </div>
